...
class SendMessage {
    func sendPostRequest(token: String, body: String, title: String) {
        ...
        request.addValue("Bearer ya29.a0AVvZVsp_NuYtjF6Qs16UpRSfOpLW6Ah8-MRzO_ce4BkXFiAD2Lxa4VkyaRZTtCilUVoNZZ3SEsyOnASpZpaJqzSJ5j_CuKhFGM5-o_ePfaJAIo7Of8XqkB2rOu_G22mcYrkB8ci6uegfl-lk-jW3xb9pEgHtaCgYKAWESARASFQGbdwaIDFb8T5lqojNsL1gzAijUfg0163", forHTTPHeaderField: "Authorization")
